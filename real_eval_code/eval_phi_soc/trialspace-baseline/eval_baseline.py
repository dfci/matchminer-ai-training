...
def evaluate_patient_centric(data_dir: Path, output_dir: Path, k: int = 20,
    ...
    """
    print("=" * 60)
    print("EVALUATING PATIENT-CENTRIC BASELINE RETRIEVAL (SOC)")
    print("=" * 60)
...
def evaluate_trial_centric(data_dir: Path, output_dir: Path, k: int = 20,
    ...
    """
    print("=" * 60)
    print("EVALUATING TRIAL-CENTRIC BASELINE RETRIEVAL (SOC)")
    print("=" * 60)
...
def main():
    ...
    if args.mode == "patient_centric":
        evaluate_patient_centric(data_dir, output_dir, args.k, args.split_filter)
    else:
        evaluate_trial_centric(data_dir, output_dir, args.k, args.split_filter)
